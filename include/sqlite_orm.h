...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct column_t : column_base {
            ...
            column_t(std::string name, member_pointer_t member_pointer_, getter_type getter_, setter_type setter_,
                     constraints_type constraints_) :
                    column_base{std::move(name)}, member_pointer(member_pointer_), getter(getter_), setter(setter_),
        ...
        template<class T>
        struct is_field_member_pointer<T, typename std::enable_if<
                std::is_member_pointer<T>::value && !std::is_member_function_pointer<T>::value>::type>
                : std::true_type {
        };
    ...
    internal::column_t<
            ...
            G, S, Op...> make_column(const std::string &name,
                                     ...
                                     Op ...constraints) {
        static_assert(
                std::is_same<typename internal::setter_traits<S>::field_type, typename internal::getter_traits<G>::field_type>::value,
        ...
        struct order_by_t : order_by_base, order_by_string {
            ...
            self collate_binary() const {
                ...
                res._collate_argument = constraints::collate_t::string_from_collate_argument(
                        internal::collate_argument::binary);
                return res;
            }
            ...
            self collate_nocase() const {
                auto res = *this;
                res._collate_argument = constraints::collate_t::string_from_collate_argument(
                        internal::collate_argument::nocase);
                return res;
            }
            ...
            self collate_rtrim() const {
                auto res = *this;
                res._collate_argument = constraints::collate_t::string_from_collate_argument(
                        internal::collate_argument::rtrim);
                return res;
            }
...
namespace sqlite_orm {
    ...
    template<
            ...
            typename = typename std::enable_if<(std::is_base_of<internal::arithmetic_t, L>::value +
                                                std::is_base_of<internal::arithmetic_t, R>::value > 0)>::type>
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct union_t : public compound_operator<L, R>, union_base {
            ...
            union_t(left_type l, right_type r, decltype(all) all) : compound_operator<L, R>(std::move(l), std::move(r)),
                                                                    union_base{all} {}
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct table_type<F O::*, typename std::enable_if<
                std::is_member_pointer<F O::*>::value && !std::is_member_function_pointer<F O::*>::value>::type> {
            using type = O;
        };
...
namespace sqlite_orm {
     ...
     */
    template<class V>
    struct statement_binder<V, std::enable_if_t<
            std::is_same<V, std::string>::value || std::is_same<V, const char *>::value>> {
        int bind(sqlite3_stmt *stmt, int index, const V &value) {
    ...
    template<class V>
    struct statement_binder<V, std::enable_if_t<
            std::is_same<V, std::wstring>::value || std::is_same<V, const wchar_t *>::value>> {
        int bind(sqlite3_stmt *stmt, int index, const V &value) {
    ...
    struct statement_binder<std::vector<char>, void> {
        int bind(sqlite3_stmt *stmt, int index, const std::vector<char> &value) {
            if (value.size()) {
                return sqlite3_bind_blob(stmt, index, (const void *) &value.front(), int(value.size()),
                                         SQLITE_TRANSIENT);
            } else {
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct column_result_t<St, F O::*, typename std::enable_if<
                std::is_member_pointer<F O::*>::value && !std::is_member_function_pointer<F O::*>::value>::type> {
            using type = F;
        };
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct table_t : table_base {
            ...
            table_t(decltype(name) name_, columns_type columns_) : table_base{std::move(name_)},
                                                                   columns(std::move(columns_)) {}
            ...
            template<class G>
            std::string
            find_column_name(G getter, typename std::enable_if<is_getter<G>::value>::type * = nullptr) const {
                std::string res;
            ...
            template<class S>
            std::string
            find_column_name(S setter, typename std::enable_if<is_setter<S>::value>::type * = nullptr) const {
                std::string res;
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        struct storage_impl_base {
            ...
            static bool get_remove_add_columns(std::vector<table_info *> &columnsToAdd,
                ...
                for (size_t storageColumnInfoIndex = 0;
                     storageColumnInfoIndex < storageTableInfo.size(); ++storageColumnInfoIndex) {
                    ...
                    if (dbColumnInfoIt != dbTableInfo.end()) {
                        ...
                        if (dbColumnInfoType && storageColumnInfoType) {
                            ...
                            storageTableInfo.erase(
                                    storageTableInfo.begin() + static_cast<ptrdiff_t>(storageColumnInfoIndex));
        ...
        struct storage_impl<H, Ts...> : public storage_impl<Ts...> {
            ...
            template<class O, class F, class HH = typename H::object_type>
            std::string
            column_name(void (O::*s)(F), typename std::enable_if<std::is_same<O, HH>::value>::type * = nullptr) const {
                return this->table.find_column_name(s);
            }
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        public:
            ...
            iterator_t(sqlite3_stmt *stmt_, view_type &view_) : stmt(std::make_shared<sqlite3_stmt *>(stmt_)),
                                                                view(view_) {
                this->operator++();
            }
    ...
    namespace internal {
                ...
                if (sqlite3_prepare_v2(db, query.c_str(), -1, &stmt, nullptr) == SQLITE_OK) {
                    ...
                    if (sqlite3_step(stmt) == SQLITE_DONE) {
                        ...
                        throw std::system_error(
                                std::error_code(sqlite3_errcode(connection->get_db()), get_sqlite_error_category()),
                                sqlite3_errmsg(db));
                    }
                } else {
                    throw std::system_error(
        ...
        protected:
            ...
            std::string serialize_column_schema(const internal::column_t<O, T, G, S, Op...> &c) {
                ...
                tuple_helper::iterator<std::tuple_size<constraints_type>::value - 1, Op...>()(c.constraints,
                                                                                              [&ss](auto &v) {
                                                                                                  ss
...
namespace sqlite_orm {
    ...
    namespace internal {
        ...
        protected:
            ...
            template<class S>
            friend
            struct conditions::dynamic_order_by_t;
            ...
            template<class R, class S, class ...Args>
            std::string
            string_from_expression(const core_functions::core_function_t<R, S, Args...> &c, bool noTableName) const {
                std::stringstream ss;
            ...
            template<class T>
            std::string
            string_from_expression(const aggregate_functions::group_concat_double_t<T> &f, bool noTableName) const {
                std::stringstream ss;
            ...
            template<class T>
            std::string
            string_from_expression(const aggregate_functions::group_concat_single_t<T> &f, bool noTableName) const {
                std::stringstream ss;
                auto expr = this->string_from_expression(f.t, noTableName);
            ...
            template<class T>
            std::string
            string_from_expression(const aggregate_functions::count_asterisk_t<T> &, bool noTableName) const {
            ...
            std::string string_from_expression(const internal::select_t<T, Args...> &sel, bool /*noTableName*/) const {
                ...
                internal::join_iterator<Args...>()([&tableNamesSet, this](const auto &c) {
                    ...
                    std::pair<std::string, std::string>
                            tableNameWithAlias(std::move(crossJoinedTableName), std::move(tableAliasString));
            ...
            std::string string_from_expression(const conditions::cast_t<T, E> &c, bool noTableName) const {
                std::stringstream ss;
                ss << static_cast<std::string>(c) << " ( " << this->string_from_expression(c.expression, noTableName)
                   << " AS " << type_printer<T>().print() << ") ";
                return ss.str();
            }
            ...
            template<class R, class T, class E, class ...Args>
            std::string
            string_from_expression(const internal::simple_case_t<R, T, E, Args...> &c, bool noTableName) const {
                std::stringstream ss;
                ss << "CASE ";
            ...
            template<class L, class E>
            std::string
            string_from_expression(const conditions::in_t<L, std::vector<E>> &inCondition, bool noTableName) const {
                std::stringstream ss;
                auto leftString = this->string_from_expression(inCondition.l, noTableName);
                ss << leftString << " " << static_cast<std::string>(inCondition) << " ( ";
            ...
            template<class S>
            void
            process_single_condition(std::stringstream &ss, const conditions::dynamic_order_by_t<S> &orderBy) const {
        ...
        public:
            ...
            std::string group_concat(F O::*m, std::string y, Args &&...args) {
                return this->group_concat_internal(m, std::make_unique<std::string>(move(y)),
            ...
            std::unique_ptr<Ret> sum(F O::*m, Args &&...args) {
                this->assert_mapped_type<O>();
                std::vector<std::unique_ptr<double>> rows = this->select(sqlite_orm::sum(m),
                                                                         std::forward<Args>(args)...);
                if (!rows.empty()) {
                    if (rows.front()) {
